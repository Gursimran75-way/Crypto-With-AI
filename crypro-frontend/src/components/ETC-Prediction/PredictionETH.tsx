...
import { usePredictPlotETHMutation } from "../../services/predictionApi";
import CloseIcon from "@mui/icons-material/Close";
import { useNavigate } from "react-router-dom";
import { useLazyFetchCoinbaseETHPricesQuery } from "../../services/latestPrices-API";
...
const PredictionETH = () => {
  ...
  const [fetchETHpriceList] = useLazyFetchCoinbaseETHPricesQuery();
  const [fetchPrediciton, { isLoading: loading }] = usePredictPlotETHMutation();
  ...
  const fetchPredictions = async () => {
    try {
      ...
      const pricesArray = await fetchETHpriceList().unwrap();
      console.log("Fetched prices ETH:", pricesArray);
        ...
        <Fade in={openDisclaimer}>
          ...
          >
            ...
            <Typography variant="body1" gutterBottom>
              This prediction is based on historical Etherium prices. Use this AI
