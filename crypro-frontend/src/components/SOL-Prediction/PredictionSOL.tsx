...
import { usePredictPlotSOLMutation } from "../../services/predictionApi";
import CloseIcon from "@mui/icons-material/Close";
import { useNavigate } from "react-router-dom";
import { useLazyFetchCoinbaseSOLPricesQuery } from "../../services/latestPrices-API";
...
const PredictionSOL = () => {
  ...
  const [fetchETHpriceList] = useLazyFetchCoinbaseSOLPricesQuery();
  const [fetchPrediciton, { isLoading: loading }] = usePredictPlotSOLMutation();
  ...
  const fetchPredictions = async () => {
    try {
      ...
      console.log("Fetched prices SOL:", pricesArray);
        ...
        <Fade in={openDisclaimer}>
          ...
          >
            ...
            <Typography variant="body1" gutterBottom>
              This prediction is based on historical Solana prices. Use this AI
